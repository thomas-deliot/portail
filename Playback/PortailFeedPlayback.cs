...
namespace Portail.Playback
{
	...
	[MovedFrom(true, "", null, "DesktopStreamPlayer")]
	public sealed class PortailFeedPlayback : MonoBehaviour
	{
		static bool s_localControlMenuVisible;

	[FormerlySerializedAs("steamStreamPlayer")]
	[FormerlySerializedAs("streamSource")]
