...
namespace streamproto::client
{
	...
	struct ClientVideoDecodeEnqueueResult
	{
		bool queued = false;
	...
	class ClientVideoDecodeQueue
	{
	public:
		using Processor = std::function<void(ClientVideoDecodeEvent)>;

		ClientVideoDecodeQueue() = default;
		~ClientVideoDecodeQueue() { Stop(); }

		ClientVideoDecodeQueue(const ClientVideoDecodeQueue &) = delete;
		ClientVideoDecodeQueue &operator=(const ClientVideoDecodeQueue &) = delete;
		...
		ClientVideoDecodeEnqueueResult Enqueue(ClientVideoDecodeEvent event)
		{
			ClientVideoDecodeEnqueueResult result{};
	...
	private:
		...
		std::deque<ClientVideoDecodeEvent> events_;
