...
namespace streamproto::client
{
	...
	struct ClientPeerQualityState
	{
		ClientMaxAcceptedQuality max_accepted{};
		ClientMaxAcceptedQuality last_max_accepted_sent{
			lod::kInvalidSentLod,
			lod::kInvalidSentLod};
		...
		bool SetMaxAcceptedQuality(const ClientMaxAcceptedQuality &quality)
		{
			ClientMaxAcceptedQuality normalized{};
