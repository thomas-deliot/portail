...
namespace streamproto::sender
{
	...
	struct SenderRouteSnapshot
	{
		...
		std::vector<std::vector<SenderMediaTarget>> video_targets_by_lod;
		std::vector<std::vector<SenderMediaTarget>> audio_targets_by_lod;
