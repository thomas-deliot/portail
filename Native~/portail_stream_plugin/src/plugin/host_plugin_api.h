...
extern "C"
{
	...
	struct SSPH_Stats
	{
		...
		std::int32_t connected_ice_clients;
		std::int32_t connected_sdr_clients;
	...
	struct SSPH_AudioLodConfig
	{
		std::int32_t enabled;
		std::int32_t bitrate_kbps;
	};

	struct SSPH_VideoLodStats
	{
		std::int32_t index;
		std::int32_t enabled;
		std::int32_t width;
