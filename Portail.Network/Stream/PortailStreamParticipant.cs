...
namespace Portail.Stream
{
	...
	public sealed class PortailStreamParticipant : NetworkBehaviour
	{
		...
		public event Action<PortailStreamParticipant, ulong> OwnerStreamIdUpdated;
		public event Action<PortailStreamParticipant, bool> BroadcastingUpdated;
