...
try {
    ...
    $expectedDlls = @(
        "..\..\Plugins\portail_stream_sender_plugin.dll",
        "..\..\Plugins\portail_stream_receiver_plugin.dll",
        "..\..\Plugins\portail_stream_common.dll",
        "..\..\Plugins\avcodec-62.dll",
        "..\..\Plugins\avdevice-62.dll",
        "..\..\Plugins\avfilter-11.dll",
        "..\..\Plugins\avformat-62.dll",
        "..\..\Plugins\avutil-60.dll",
        "..\..\Plugins\swresample-6.dll",
        "..\..\Plugins\swscale-9.dll"
    )
    ...
    $optionalSteamWebRtc = Join-Path $sourceDir "..\..\Plugins\steamwebrtc64.dll"
