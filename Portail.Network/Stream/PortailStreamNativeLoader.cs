...
namespace Portail.Stream
{
	internal static class PortailStreamNativeLoader
	{
		...
		public static bool EnsureLoaded()
		{
			...
			string nativeExternalDllDir = Path.Combine(packageRoot, "Stream", "Native~", "portail_stream_plugin", "external DLLs");
			...
			{
				_lastError = "steam_api64.dll not found in Stream/Native~/portail_stream_plugin/external DLLs, Facepunch, or PortailStream plugin folders.";
				Debug.LogError($"[PortailStreamLoader] {_lastError}");
				return false;
			}
